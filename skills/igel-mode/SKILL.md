...
The Principles section below grounds every trigger. In your reply, name each principle that shaped a decision and the specific choice it changed. Cite only principles whose leaf SKILL.md you read this session. Highlight in your response which principles were used sorrounded by `#` so i can easily idetify the block. The block should look something like this:
...
- Any prose surface → the **unslop** skill. Your reply is a prose surface. Write it per **Writing the reply**. Agent-facing prose also follows the **write-for-agent** skill.
...
- **Review.** A behaviour on how to review and PR commenting. `playbooks/review.md`
- **Refactoring.** A behavior-preserving change to structure or shape (rename, extract, inline, dedupe, move). `playbooks/refactoring.md`.
- **Authoring or modifying a skill.** Writing or editing a SKILL.md. `playbooks/skill-authoring.md`.
